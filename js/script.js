$(document).ready(function() {
    ...
    const files = [{
        ...
        },
        {
            ...
            path: "",
            action: function() {
                $(".prompt").before("<div class='output'>Welcome to WINDOSE! Type 'help' to see available commands.</div>");
            }
        },
        {
            name: "INLINEBUFFER.PC",
            target: "command",
            path: "",
            action: function() {
                $(".command").hide();
    ...
    // Handle click(s) outside of prompt box
    $(".terminal").click(function() {
        $(".command").focus();
    });

    // Prevent user from opening the context-menu (right-clicking)
    // Not meant to hide the source files, but more so for immersion
